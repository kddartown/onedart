...
There are three main types of items that are found in KDSmart. These are trials, traits, and tags (sometimes referred to as TTT).
...
.. list-table:: KDSmart Home Screen
  ...
  * - **3.**
    - |bright_btn|
    - Changes the brightness settings from *Dark Mode* to *Light Mode* (Note that this has been deprecated in the current version - it is likely to come back in future versions).
  * - **4.**
    - |lock_btn|
  ...
  * - **6.**
    - |KDDart|
    - Navigates to the KDDart web page.
  * - **7.**
    - |DArray|
