...
[KDSmart Documentation ![](_static/logo.png)](#)
...
# KDSmart User Guide[¶](#kdsmart-user-guide "Permalink to this headline")
...
[![](_images/system_design_principles_v2.png)](_images/system_design_principles_v2.png "KDDart System Design Principles - Integrated Platform (select to zoom)")
...
[![](_images/KDDart_Application_Network_Dependency.png)](_images/KDDart_Application_Network_Dependency.png "KDDart Application Network Dependency (select to zoom)")
...
[![](_images/KDDart_Trial_Data_Workflow.png)](_images/KDDart_Trial_Data_Workflow.png "Example of the Trial Data Workflow (select to zoom)")
...
<https://play.google.com/store/apps/details?id=com.diversityarrays.kdsmart>.\
...
*   Of the KDDart environment at:\
    [Introduction to the KDDart Environment](http://www.kddart.org/introduction.html) ; followed by
*   [The KDSmart Application](http://www.kddart.org/kdsmart.html)
...
For KDSmart tutorials (along with tutorials for our other applications), please see the [KDDart Tutorials](http://www.kddart.org/help/kdtutorials/html/index.html) page.

Note

*   March 2019 - We are constantly improving KDSmart and welcome any feedback or queries. You can contact us by email at [kdsmart@diversityarrays.com](mailto:kdsmart%40diversityarrays.com) if you want to get in touch.
*   Sample files are now located on the [Sample Files](kdsmart-sample-files.html#kdsmart-kdxplore-sample-files) page.

[Next](kdsmart-basics.html "Getting Started")
