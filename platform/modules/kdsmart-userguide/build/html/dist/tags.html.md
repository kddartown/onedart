...
## What is a Tag?[¶](#what-is-a-tag "Permalink to this headline")
...
When tags have been assigned to a plot or sub-plot they will appear as shown in the following image, which shows part of the **Scoring Screen** with two tags assigned at [!["1"](_images/1_26.png)](_images/1_26.png) which is above the trait column. Tags are assigned or reassigned using the [![assign\_tag\_btn](_images/ic_action_new_label_black1.png)](_images/ic_action_new_label_black1.png) **Assign Tag Button** at [!["2"](_images/2_26.png)](_images/2_26.png).

[![](_images/tags13.png)](_images/tags13.png "Example of Two Applied Tags on the Scoring Screen")
...
## Tag Management[¶](#tag-management "Permalink to this headline")

Tags are managed from the **Tags Screen** which can be accessed by selecting the [![tag\_btn](_images/kds_tags.png)](_images/kds_tags.png) **Tags Button** on the **Home Screen** or through the **Menu**. The following actions can be performed at the **Tags Screen**:
...
[![](_images/tags1.png)](_images/tags1.png "Tags Screen")

Tags Screen

### Adding Tags[¶](#adding-tags "Permalink to this headline")

Tags can either be created in KDSmart or imported. Follow the instructions below to create a new tag.

| **Step** | **Action**                                                                                                                                                                                                                                                                               |
| -------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **1.**   | Open the **Tags Screen** and select the [![add\_tag\_btn](_images/ic_action_new.png)](_images/ic_action_new.png) **Add Tag Button**.                                                                                                                                                     |
| **2.**   | Enter a *Label* (tag name) such as ‘HD’ in the image below. Select the *Use* option to check if the name for the tag is free and confirm it.[![](_images/tags2.png)](_images/tags2.png "Choosing a Tag Name")Choosing a Tag Name                                                         |
| **3.**   | A description can be added once the tag name has been confirmed. Enter the description into the text field and then select the **Confirm Button** (the tick) to confirm the name and description of the tag.[![](_images/tags3.png)](_images/tags3.png "Tag Description")Tag Description |
| **4.**   | A dialogue box will open and you will need to choose to cancel, edit, or confirm your new tag details.> [![](_images/tags4.png)](_images/tags4.png "Saving a Tag")
>
> Saving a Tag                                                                                                      |

### Editing Tags[¶](#editing-tags "Permalink to this headline")

Tags can be edited once they have been created. The instructions below outline how to edit a tag.

| **Step** | **Action**                                                                                                                                                                                                                                              |
| -------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **1.**   | Open the **Tags Screen** and select a tag that you would like to edit.                                                                                                                                                                                  |
| **2.**   | Select the [![edit\_btn](_images/ic_action_edit.png)](_images/ic_action_edit.png) **Edit Button** as in the image below. This will present a screen like the **Add Tag Screen**[![](_images/tags5.png)](_images/tags5.png "Editing a Tag")Editing a Tag |
| **3.**   | Edit the tag name and/or tag description and select the **Confirm Button**.[![](_images/tags6.png)](_images/tags6.png "Confirming an Edited Tag")Confirming an Edited Tag                                                                               |
| **4.**   | A dialogue box will open and you will need to choose to cancel, edit, or confirm the edited tag details.[![](_images/tags4.png)](_images/tags4.png "Saving a Tag")Saving a Tag                                                                          |

### Deleting Tags[¶](#deleting-tags "Permalink to this headline")
...
| **Step** | **Action**                                                                                                                                                                                                                                                                                      |
| -------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **1.**   | Select the tags that you want to delete by *long-pressing* it. *Short-pressing* any additional tags will allow you to multi-select multiple tags for deletion.[![](_images/tags9.png)](_images/tags9.png "Multi-selecting Tags")Multi-selecting Tags                                            |
| **2.**   | Select the [![menu\_btn](_images/ic_action_overflow_black.png)](_images/ic_action_overflow_black.png) **Menu Button** to view additional options.                                                                                                                                               |
| **3.**   | Select the *Delete Tags* option from the menu items.                                                                                                                                                                                                                                            |
| **4.**   | A message will be displayed that will list any tags that cannot be deleted because they are currently being used in a trial. Select the [![delete\_btn](_images/ic_action_discard.png)](_images/ic_action_discard.png) **Delete Button** to delete any tags that are not being used in a trial. |

## Tag Bundles[¶](#tag-bundles "Permalink to this headline")
...
| **Step** | **Action**                                                                                                                                                                                                                                                                            |
| -------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **1.**   | Select the tags that you want to create a bundle with by *long-pressing* a tag and then *short-pressing* any additional tags. This will allows you to multi-select multiple tags.[![](_images/tags9.png)](_images/tags9.png "Selecting Tags for a Bundle")Selecting Tags for a Bundle |
| **2.**   | Select the [![menu\_btn](_images/ic_action_overflow_black.png)](_images/ic_action_overflow_black.png) **Menu Button** to view additional options.                                                                                                                                     |
| **3.**   | Select the *Add Bundle* option from the menu items. This will take you to the **Add Tag Bundle Screen** which lists the selected tags and bundles that have already been created.[![](_images/tags10.png)](_images/tags10.png "Add Tag Bundle Screen")Add Tag Bundle Screen           |
| **4.**   | Enter a bundle name and then select the **Create/Add Button** to create a new bundle.[![](_images/tags11.png)](_images/tags11.png "Creating a New Bundle")Creating a New Bundle                                                                                                       |
| **5.**   | You can also select a current bundle which will display a new **Add Button**. Select that button to add the selected tags to an existing bundle.> [![](_images/tags12.png)](_images/tags12.png "Adding Tags to an Existing Bundle")
>
...
| **Step** | **Action**                                                                                                                                                          |
| -------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **1.**   | Locate a plot or sub-plot to tag in the **Scoring Screen**.[![](_images/tags14.png)](_images/tags14.png "Tags on the Scoring Screen")Tags on the Scoring Screen     |
| **2.**   | Select the [![assign\_tag\_btn](_images/ic_action_new_label_black1.png)](_images/ic_action_new_label_black1.png) **Assign Tag Button**.                             |
| **3.**   | Select one or more tags to assign them to a plot.[![](_images/tags15.png)](_images/tags15.png "Assigning Tags")Assigning Tags                                       |
...
Assigning tags is often an integral part of scoring. For more information about scoring see the [Scoring](http://www.kddart.org/help/kdsmart/html/kdsmarthelp.html) page.

Note

Information on importing and exporting data such as tags can be found in the [Data Import, Export & Backup](http://www.kddart.org/help/kdsmart/html/data-import-export-backup.html) page.

[Next ](preparation.html "Preparing for Scoring")[Previous](traits.html "Traits")
